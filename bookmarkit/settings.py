"""
Django settings for bookmarkit project, on Heroku. Fore more info, see:
...
# DJOSER CONFIRUATION
DJOSER = {
    'DOMAIN': 'bk-it.herokuapp.com',
    'SITE_NAME': 'Bookmark-it',
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'bookmarkit/static'),
)
